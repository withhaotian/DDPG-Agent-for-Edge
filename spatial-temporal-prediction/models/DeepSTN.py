...
# main model
def Deep_STN(H=21,W=12,      #H-map_height W-map_width channel-map_channel
            ...
            is_plus_efficient=True,  #use the efficient version of ResPlus
    ...
    cpt_conv1=Conv2D(filters=1,kernel_size=(1, 1),padding="same")(cpt_conv1)
...
if __name__ == '__main__':
    model = Deep_STN(H=75,W=90,
                      is_plus=False,plus=8,rate=1,
                      drop=0.2)